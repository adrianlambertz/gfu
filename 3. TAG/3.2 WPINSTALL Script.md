...
**Folgenden Inhalt reinkopieren**
    ...
    ssssssssso/.    :ssso  .----`   .ossss. /sssssssssssso  +sss+          :ssssssssso:`      `/syhdhyo:`   `sssssssso+/.
    ddddddddddddy-  /dddh   -::::. -hdddh-  oddddddddddddh` sddds          /ddddhhhddddd/   `+ddddddddddh/  `ddddddddddddy-
    dddd+---/ydddh` /dddh    -:::::ddddy.   odddh---------  sddds          /dddd```.odddd`  sdddh/-.-odddd/ `dddd+---:ydddh`
    dddd/   `+dddd- /dddh     .::::+dds`    odddh::::::-    sddds          /dddd:--:yddh+  `dddd/     sdddy `dddd:    +dddd.
    ddddyoosydddds` /dddh      .::::/s`     oddddddddddh    sddds          /ddddddddddds-  `dddd+:::::sdddy `ddddyoooyddddo
    ddddddddddhs/`  /dddh     `::::/yd/     odddh++++++/    sddds          /dddd:--:+hddd+ `ddddddddddddddy `ddddddddddds:
    ddddo----.`     /dddh    .:////hmdd+    odddy`          sddds          /dddd    `sdddh``ddddyooooohdddy `dddd+.-yddds`
    dddd/           /dddh   .////:`+dddds`  oddddhhhhhhhhy` sddddhhhhhhhh: /ddddsssshdddd+ `dddd:     odddy `dddd:  `sdddy.
    dddd/           /dddh  -////-   :hdddy. oddddddddddddh` sdddddddddddd/ /dddddddddhyo-  `dddd:     odddy `hddd:   `odddh:
    `````           `````  `````     `````` ``````````````  `````````````` ``````````       ````      `````  ````      `````
